...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        //.requestMatchers( "/api/chat/create").hasRole("ORGANIZER")
                        //.requestMatchers( "/api/chat/owner{ownerUsername}").hasRole("PARTICIPANT")
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        System.out.println("CORS настроен для: " + configuration.getAllowedOrigins()); // Логируем
